...
export interface IAccordionButtonProps
  extends ComponentProps<typeof SAccordionButton> {
  /**
...
const AccordionTextToggle = ({
  open = false,
  hideLabel,
  showLabel,
}: IAccordionTextToggleProps) => (
  <Copy
    as="span"
    scale={8}
...
export const AccordionButton = ({
  ...
  const { textToggle, onItemOpen, onItemClose } =
    useAccordionContext("AccordionButton");
  const { id, value, open, disabled } =
    useAccordionItemContext("AccordionButton");
